...
class PositionedList extends StatefulWidget {
  ...
  /// Make sure that [separatorBuilder] is [null] if you're using
...
class _PositionedListState extends State<PositionedList> {
  ...
  bool get _canUseFindChildIndexCallback =>
      widget.separatorBuilder == null && widget.findChildIndexCallback != null;
              ...
              SliverPadding(
                ...
                sliver: SliverList(
                  delegate: SliverChildBuilderDelegate(
                    ...
                    findChildIndexCallback: _canUseFindChildIndexCallback
                        ? (key) {
                            final _index = widget.findChildIndexCallback(key);
                            if (_index == null) return null;

                            return widget.positionedIndex - _index - 1;
                          }
                        : null,
                  ),
                ),
                ...
                delegate: SliverChildBuilderDelegate(
                  ...
                  findChildIndexCallback: _canUseFindChildIndexCallback
                      ? (key) {
                          ...
                          return _index - widget.positionedIndex;
                        }
                      : null,
                ),
              ),
                  ...
                  delegate: SliverChildBuilderDelegate(
                    ...
                    findChildIndexCallback: _canUseFindChildIndexCallback
                        ? (key) {
                            ...
                            return _index - widget.positionedIndex - 1;
                          }
                        : null,
                  ),
                ),
  ...
  Widget _buildItem(int index) {
    ...
    final key =
        widget.findChildIndexCallback != null ? child.key : ValueKey(index);

    return RegisteredElementWidget(
      key: key,
      child: widget.addSemanticIndexes
          ? IndexedSemantics(key: key, index: index, child: child)
          : child,
    );
  }
  ...
  void _schedulePositionNotificationUpdate() {
    if (!updateScheduled) {
      ...
      SchedulerBinding.instance.addPostFrameCallback((_) {
        final getItemIndex = (ValueKey key) {
          return widget.findChildIndexCallback != null
              ? widget.findChildIndexCallback(key)
              : key.value;
        };
        ...
        for (var element in registeredElements.value) {
          try {
            ...
            // Ignore the error.
            // TODO: Investigate the reason why the errors happen
          }
        }
